...
SpriteSheet::SpriteSheet(GLuint textureID, float scale, float u, float v, float width, float height)
	: textureID(textureID), scale(scale), u(u), v(v), width(width), height(height) {}
